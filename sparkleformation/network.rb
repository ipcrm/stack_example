SparkleFormation.new(:network) do
  ...
  dynamic!(:ec2_subnet, :network1) do
    properties do
      availability_zone select!(1, azs!)
  ...
  outputs do
    ...
    network_subnet_id1.value ref!(:network_ec2_subnet)
    network_subnet_id2.value ref!(:network1_ec2_subnet)
